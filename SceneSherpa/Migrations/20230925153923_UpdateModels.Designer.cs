...
namespace SceneSherpa.Migrations
{
    ...
    [Migration("20230925153923_UpdateModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserUser", b =>
                {
                    b.Property<int>("FriendedId")
                        .HasColumnType("integer")
                        .HasColumnName("friended_id");

                    b.Property<int>("FriendsId")
                        .HasColumnType("integer")
                        .HasColumnName("friends_id");

                    b.HasKey("FriendedId", "FriendsId")
            ...
            modelBuilder.Entity("UserUser", b =>
                {
                    b.HasOne("SceneSherpa.Models.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_user_users_friended_id");
